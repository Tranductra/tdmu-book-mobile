...
class PanoramaViewer2 extends StatefulWidget {
  const PanoramaViewer2({super.key});

  @override
  _PanoramaViewer2State createState() => _PanoramaViewer2State();
}

class _PanoramaViewer2State extends State<PanoramaViewer2> {
      ...
      body: Stack(
        children: [
          PanoramaViewer(
            animSpeed: 0,
            child: Image.asset(
                'assets/images/guest/virtual/img_virtual_san_co.jpg'),
            hotspots: [
              Hotspot(
